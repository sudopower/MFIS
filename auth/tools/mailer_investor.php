<?php 
include('../session.php');
if(isset($_GET['todo']) and $_GET['todo']==1){
    $q='select inv_name,email,username,password from investors where sno="'.$_GET['tid'].'"';
$result_detail=$db->query($q);
$row=$result_detail->fetch_array();
$name=$row['inv_name'];
...
require('../../assets/phpmailer/src/Exception.php');
        ...
        $mail->SMTPSecure = "tls";
        $mail->Port     = 587;  
        $mail->Username = "nkirandroid@gmail.com";
        $mail->Password = "#Pcmasterrace@9137245036";
        $mail->Host     = "smtp.gmail.com";
        $mail->Mailer   = "smtp";
        $mail->SetFrom("nkirandroid@gmail.com", "Kiran Nambiar");
        $mail->AddReplyTo("nkirandroid@gmail.com", "Kiran Nambiar");
        $mail->AddAddress($inv_email);
        $mail->Subject = "Mutual Funds Dashboard Login";
        $mail->WordWrap   = 80;
                                                                                    ...
                                                                                    <th>
                                                                                        <center data-parsed="">
                                                                                            <a href="http://www.sendwithus.com" align="center" class="text-center">
                                                                                                <img src="http://p3cdn4static.sharpschool.com/UserFiles/Servers/Server_1109171/Image/L2.png" class="swu-logo">
                                                                                            </a>
                                                                                        </center>
                                                                                    </th>
                                                                                    <th class="expander"></th>
                                                                                                ...
                                                                                                <th class="small-12 large-12 columns first last">
                                                                                                    <table>
                                                                                                        <tr>
                                                                                                            <th>
                                                                                                                <b><h2>Welcome !</h2></b>
                                                                                                                <p>These are your credentials to Log into your Dashboard</p>
                                                                                                                ...
                                                                                                                <div class="button">
                                                                                                                    <!--[if mso]>
                                                                                                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" strokecolor="#f7931d" fillcolor="#f7931d">
                                                                                                                          <w:anchorlock/>
                                                                                                                          <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Click to Login</center>
                                                                                                                        </v:roundrect>
                                                                                                                    <![endif]-->
                                                                                                                    <a href="#" style="background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:35px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Click to Login</a>
                                                                                                                </div>
                                                                                                            </th>
                                                                                                            <th class="expander"></th>
                                                                                                        </tr>
                                                                        ...
                                                                        <table class="row grey"><tbody><tr>
                                                                                    <th class="small-12 large-12 columns first last">
                                                                                        <table>
                                                                                            <tr>
                                                                                                <th>
                                                                                                    <p class="text-center footercopy">&#xA9; Copyright 2016 Arpit Dubey. All Rights Reserved.</p>
                                                                                                </th>
                                                                                                <th class="expander"></th>
                                                                                            </tr>
                                                                                        </table>
        ...
        echo 'Successfully Sent Credentials';     
}
?>